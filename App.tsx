...
const App: React.FC = () => {
  ...
  const dashboardComponent = useMemo(() => {
    ...
    switch (user.role) {
      ...
      case UserRole.COMPOUNDER: return <CompounderDashboard user={user} />;
        ...
        <footer className="bg-slate-950 text-white py-20 px-6 border-t border-white/5">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
            <div className="col-span-1 md:col-span-2">
              <h3 className="text-3xl font-black font-heading mb-6 text-sky-400 tracking-tight">SwasthAI.</h3>
              <p className="text-slate-500 max-w-sm text-lg leading-relaxed font-medium">
                The world's first decentralized medical ecosystem powered by clinical-grade AI.
              </p>
            </div>
            <div>
              <h4 className="font-black mb-6 uppercase tracking-[0.3em] text-[10px] text-sky-500/80">Platform</h4>
              <ul className="space-y-4 text-slate-400 font-bold text-sm">
                <li><a href="/" className="hover:text-white transition-colors">Portal Home</a></li>
                <li><a href="#/about" className="hover:text-white transition-colors">Our Vision</a></li>
                <li><a href="#/signup" className="hover:text-white transition-colors">Patient Registry</a></li>
              </ul>
            </div>
            <div>
              <h4 className="font-black mb-6 uppercase tracking-[0.3em] text-[10px] text-sky-500/80">Support</h4>
              <ul className="space-y-4 text-slate-400 font-bold text-sm">
                <li>Help Center</li>
          ...
          <div className="max-w-7xl mx-auto mt-20 pt-10 border-t border-white/5 text-center text-slate-700 text-[9px] font-black uppercase tracking-[0.4em]">
            &copy; {new Date().getFullYear()} SwasthAI Technologies. Secured Core.
          </div>
        </footer>
      </div>
    </Router>
